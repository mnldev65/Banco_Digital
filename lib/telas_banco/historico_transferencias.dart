      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return const Center(child: Text('Nenhuma transferência realizada.'));
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              var dados = listaTransferencias[index].data() as Map<String, dynamic>;
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  title: Text(destinatario, style: const TextStyle(fontWeight: FontWeight.bold)),
